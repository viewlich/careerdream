...
Vcity.allCity = ['北京|beijing|bj','上海|shanghai|sh', '香港|xianggang|xg',  '深圳|shenzhen|sz', '广州|guangzhou|gz', '武汉|wuhan|wh', '杭州|hangzhou|hz',
    ...
    '张家界|zhangjiajie|zjj', '舟山|zhoushan|zs', '郑州|zhengzhou|zz', '中卫|zhongwei|zw', '芷江|zhijiang|zj', '湛江|zhanjiang|zj','重庆|chongqing|cq'];
